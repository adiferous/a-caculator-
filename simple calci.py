...
button_add = Button(root, text="+", padx=35, pady=35, command=button_add)
button_add.grid(row=4, column=1)

button_subtract = Button(root, text="-", padx=35, pady=35, command=button_subtract)
button_subtract.grid(row=4, column=2)

button_multiply = Button(root, text="*", padx=35, pady=35, command=button_multiply)
button_multiply.grid(row=5, column=0)

button_divide = Button(root, text="/", padx=35, pady=35, command=button_divide)
button_divide.grid(row=5, column=1)

button_equalto = Button(root, text="=", padx=35, pady=80, command=button_equalto)
button_equalto.grid(row=5, column=2, rowspan=2)

button_clear = Button(root, text="Clear", padx=70, pady=35, command=button_clear)
